...
def test_specific_examples():
    print("Testing specific problematic examples with fuzzywuzzy:")
    print("-" * 50)
    ...
    match, confidence = find_best_wine_match_fuzzy(tokens)
    ...
    match2, confidence2 = find_best_wine_match_fuzzy(tokens2)
    ...
    match3, confidence3 = find_best_wine_match_fuzzy(tokens3)
